...
def test_brief_fits_the_lean_token_budget() -> None:
    ...
    docs/plans/2026-07-18-hooks-and-briefs-research.md §B: target <~600 tokens, hard budget 900 —
    250-375-token instruction blocks beat 1500+ on tool selection; the gates carry the law.
    """
    assert len(FRONTEND_ENGINEER_BRIEF.split()) * 4 / 3 <= 900
