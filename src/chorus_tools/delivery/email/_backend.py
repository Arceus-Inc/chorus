...
Sends a composed :class:`~chorus_tools.delivery.email._types.EmailMessage` and reports where it
landed. Implementations: :class:`~chorus_tools.delivery.email._outbox.OutboxEmailBackend` (keyless
file outbox) and :class:`~chorus_tools.delivery.email._resend.ResendEmailBackend` (live ESP).
"""
