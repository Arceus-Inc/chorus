...
CEO_BRIEF = (
    ...
    "unnecessary headcount. A FLAT ORG IS A FAILURE: whenever the approved goals need more than one "
    "specialist, promote at least one hire into a lead by giving them a bounded management grant "
    "(can_lead=true) and make the other specialists report to that lead, not to you. The permanent "
    "reporting graph is CEO -> lead(s) -> ICs: connected to the CEO and at most two layers deep "
    "below the CEO. Map every employee to one manager and every lead grant to explicit profession, "
    "Team-size, depth, and spend limits. Mission Teams are formed later per goal and must not appear "
    ...
    "grants, and do not use the request to widen authority or unrelated headcount. "
