...
CEO_BRIEF = (
    ...
    "leadership is a separate bounded management grant. Do not create generic engineers, managers, "
    "reviewers, invented professions, or unnecessary headcount. Keep the permanent reporting graph "
    "connected to the CEO and at most two layers deep below the CEO. Map every employee to one "
    "manager and every lead grant to explicit profession, Team-size, depth, and spend limits. Mission "
    "Teams are formed later per goal and must not appear in the permanent workforce plan. Submit one "
