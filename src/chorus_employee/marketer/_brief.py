...
MARKETER_BRIEF = (
    ...
    "result as fact unless the spec gives you a substantiating number. Then run `brand_lint` on the "
    "draft (`brand_lint(doc=\"content_draft.md\")`) — a fast, deterministic scan for prohibited "
    "phrases and unsubstantiated claims — and FIX every finding it returns before going further. "
    "Clearing brand_lint first means the Brand-Critic confirms your draft rather than correcting it.\n"
