...
MARKETER_BRIEF = (
    ...
    "3. Spawn the `brand_critic` to review — and hand it a REAL task in the `prompt`, never a "
    ...
    "4. If it returns FAIL, apply EVERY fix it names in one revision, then re-spawn — and in the "
