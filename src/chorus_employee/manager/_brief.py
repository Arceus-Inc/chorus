...
MANAGER_BRIEF = (
    ...
    "- AUTHOR THE CONTRACT FIRST. Before (or as part of) your kickoff decompose, WRITE `AGENTS.md` at the "
    "repo root with `write_file`, declaring the deliverable's: MODULE MAP (each source file the package "
