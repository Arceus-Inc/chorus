...
description: Size a market with TAM, SAM, and SOM (total addressable, serviceable addressable, serviceable obtainable) using top-down and bottom-up estimates to ground an opportunity.
when_to_use: Use when estimating the size of a market opportunity — to justify investment or scope with defensible top-down and bottom-up numbers.
---
...
See `references/sample.md` for a full TAM/SAM/SOM analysis example.
