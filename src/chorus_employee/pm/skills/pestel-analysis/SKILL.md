...
description: Scan the external environment across Political, Economic, Social, Technological, Environmental, and Legal factors to surface risks and forces that could affect a product decision.
when_to_use: Use when assessing external risks and macro forces around a decision or market entry — to separate risks to investigate now from ones to monitor.
---
...
See `references/sample.md` for a full PESTEL analysis example.
