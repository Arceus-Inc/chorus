...
description: Map a desired outcome to the customer opportunities beneath it and the candidate solutions under each — Teresa Torres' framework for keeping delivery tied to discovery.
when_to_use: Use when connecting a business outcome to specific opportunities and solution bets — to avoid jumping to a solution before mapping the opportunity space.
---
...
See `references/sample.md` for full OST examples.
