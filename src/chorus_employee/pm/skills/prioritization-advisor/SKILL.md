...
description: Prioritize features or initiatives with a structured scoring method (RICE, WSJF, or value-vs-effort), turning a messy backlog into a ranked, defensible order.
when_to_use: Use when ranking a backlog or deciding what to build next — to score options on reach, impact, confidence, and effort rather than gut feel.
---
