...
description: Craft a positioning statement — for [target] who [need], [product] is a [category] that [benefit], unlike [alternative] — to align the team on how the product is framed in the market.
when_to_use: Use when defining or sharpening how a product is positioned against alternatives — before messaging, launch, or a go-to-market push.
---
...
See `references/sample.md` for full positioning examples.
