...
description: Run a complete discovery cycle from initial problem hypothesis to validated solution, orchestrating problem framing, customer interviews, synthesis, and experimentation.
when_to_use: Use when planning or running a customer discovery effort end to end — from research goals through interviews to synthesis.
---
...
See `references/sample.md` for a full discovery process example.
