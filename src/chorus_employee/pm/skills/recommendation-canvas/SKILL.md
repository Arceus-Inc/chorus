...
description: Evaluate and propose an AI product solution with a structured canvas — business and customer outcomes, problem framing, solution hypothesis, positioning, assumptions, PESTEL risks, value justification, and success metrics. Use when proposing an AI feature or securing sponsorship.
when_to_use: Use when proposing a new AI-powered product or feature, pitching to execs, or evaluating whether an AI solution is worth pursuing — after initial discovery work.
---
