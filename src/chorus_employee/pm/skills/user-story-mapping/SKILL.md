...
description: Map a user's journey into a two-dimensional story map — the backbone of activities across the top, detailed stories prioritized beneath — to plan releases around whole experiences.
when_to_use: Use when breaking a feature or product into user stories organized by the user's journey — to slice releases that deliver a coherent experience.
---
...
See `references/sample.md` for a full story map example.
