...
description: Develop a Product Requirements Document — problem, goals, users, scope, requirements, success metrics, and open questions — as the single source of truth for a feature.
when_to_use: Use when specifying a feature for a team to build — to turn a settled decision into buildable requirements.
---
...
See `references/sample.md` for full PRD examples.
