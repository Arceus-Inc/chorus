---
name: lean-ux-canvas
description: Run the Lean UX Canvas — business problem, outcomes, users, benefits, solutions, hypotheses, assumptions, and the riskiest thing to learn first — to turn assumptions into experiments.
when_to_use: Use when planning a lean experiment or aligning a team on assumptions to test — to find the riskiest assumption and the smallest test for it.
---
...
See `references/sample.md` for full Lean UX Canvas examples.
