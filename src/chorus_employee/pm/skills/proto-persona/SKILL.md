---
name: proto-persona
description: Create an initial, assumption-based persona that synthesizes available research, market data, and stakeholder knowledge into a working hypothesis about the target user — to align a team early in discovery.
when_to_use: Use when capturing a provisional, assumption-based persona early in discovery — before you have the research to build a validated persona.
---
...
See `references/sample.md` for full proto-persona examples.
