...
description: Guide a team through MITRE's Problem Framing Canvas — Look Inward, Look Outward, and Reframe — to produce a clear, bias-resistant problem statement before committing to a solution.
when_to_use: Use when framing a problem space before committing to a solution — to separate the problem, its context, and constraints from any particular fix.
---
...
See `references/sample.md` for full problem framing examples.
