...
description: Frame an epic as a testable hypothesis — we believe [capability] for [audience] will achieve [outcome]; we'll know we're right when [signal] — so a big bet carries a falsifiable claim.
when_to_use: Use when committing to a large initiative — to state it as a measurable hypothesis with a leading signal, rather than an assumed win.
---
...
See `references/sample.md` for full epic hypothesis examples.
