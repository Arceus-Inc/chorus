...
description: Articulate a problem from the user's perspective using an empathy-driven framework — who they are, what they're trying to do, what's blocking them, why, and how it makes them feel. Use this to ground a problem before proposing any solution.
when_to_use: Use when articulating a user problem from their perspective — who they are, what they're trying to do, what blocks them, why, and how it feels — before framing any solution.
---
...
See `references/sample.md` for full examples (good and bad problem statements).
