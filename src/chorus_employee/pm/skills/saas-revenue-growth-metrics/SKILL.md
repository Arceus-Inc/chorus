...
description: Read the SaaS growth metrics that matter — MRR/ARR, net and gross revenue retention, growth rate, and expansion — with reference points for healthy versus warning-sign patterns.
when_to_use: Use when evaluating or reporting SaaS growth health — to interpret MRR, retention, and expansion against healthy benchmarks and warning signs.
---
...
See `references/healthy-saas.md` and `references/warning-signs.md` for detailed scenarios. Mini examples below:
