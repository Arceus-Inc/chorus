...
description: Systematically explore what customers are trying to accomplish (functional, social, and emotional jobs), the pains they experience, and the gains they seek — to uncover and validate unmet needs.
when_to_use: Use when uncovering what customers are trying to accomplish (functional, social, emotional jobs), the pains they hit, and the gains they seek — to find unmet needs.
---
...
See `references/sample.md` for full JTBD examples.
