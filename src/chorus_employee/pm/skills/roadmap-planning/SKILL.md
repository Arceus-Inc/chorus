...
description: Build an outcome-oriented product roadmap (now/next/later or theme-based) that sequences work against goals and communicates intent without over-committing to dates.
when_to_use: Use when planning or communicating what the team will pursue over the coming quarters — to sequence bets against outcomes, not a dated feature list.
---
...
See `references/sample.md` for full roadmap examples.
