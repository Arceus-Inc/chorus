...
PM_BRIEF = (
    ...
    "CRITICAL: spawn the Critic ONE TIME ONLY. Do NOT spawn it again to re-check your revision. If a "
    ...
    "   HARD RULE — the Critic runs EXACTLY ONCE. After it returns, do NOT call `spawn_subagent` again "
    "for ANY reason (not the Critic to re-check, not the researcher). Apply its verdict by revising "
