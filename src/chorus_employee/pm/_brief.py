...
PM_BRIEF = (
    ...
    "low-confidence, uncited decision is refused — if refused, re-call `record_decision` with the "
    "claims you ALREADY gathered (do not launch another research sweep).\n"
