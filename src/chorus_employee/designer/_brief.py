...
DESIGNER_BRIEF = (
    ...
    "(expensive) Critic — fix everything it flags on-system, then re-lint until it is clean.\n"
    ...
    "Re-`design_lint`, then re-spawn the Critic stating EXACTLY WHAT YOU CHANGED so it re-checks the "
