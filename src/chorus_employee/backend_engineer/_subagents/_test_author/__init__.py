...
TEST_AUTHOR_SUBAGENT = SubagentSpec(
    ...
    description=(
        ...
        "the `skill` tool (`test-driven-development` for the RED cycle, then "
        "`testing-honeycomb-strategy` for suite shape) — fork the proven method, don't invent one. "
        "Prefer the parent loading those skills itself; you exist when isolation earns a separate "
        "test author.\n"
