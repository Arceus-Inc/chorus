...
ANALYST_BRIEF = (
    ...
    "and always use relative paths (e.g. `events.csv`). Start by understanding what data you have: use "
    ...
    "`SELECT name FROM sqlite_master WHERE type='table'`). For computation, prefer `notebook_run`: it is "
