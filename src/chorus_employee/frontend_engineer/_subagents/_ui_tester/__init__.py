...
UI_TESTER_SUBAGENT = SubagentSpec(
    ...
    description=(
        ...
        "(`test_evidence/e2e.txt`) with `read_file`. Read the app's entry/source (start from "
        "`package.json` to find it) to know the real controls and the flows the app actually offers.\n"
