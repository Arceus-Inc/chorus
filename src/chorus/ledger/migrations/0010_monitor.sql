-- Migration 0010 — monitor (spec 01 Cluster B): deferred one-shot self-wake.
-- Immutable once shipped: never edit; add a new numbered .sql instead.
-- Declarative copy lives in ../schema/monitor.sql; test_schema_parity asserts they agree.
