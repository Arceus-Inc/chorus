...
class DreamBeatRunner:
    ...
    async def _run_task(
        ...
        *,
        ...
        # *conversation* that produced it. The scheduler binds the persisted
        # handle's key via :meth:`for_session_scope`; unbound callers fall back
        # to the task-derived key above.
